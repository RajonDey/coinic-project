...
const Footer = () => (
  <div className="w-full flex md:justify-center justify-center items-center flex-col p-4 white-glassmorphism">
    ...
    <div className="flex justify-center items-center flex-col mt-5">
      ...
      <p className="text-dark text-sm text-center font-medium mt-2">
        info@coinic.com
      </p>
    </div>
    ...
    <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
      <p className="text-dark text-left text-xs">@coinic</p>
      <p className="text-dark text-right text-xs">All rights reserved</p>
    </div>
  </div>
);
